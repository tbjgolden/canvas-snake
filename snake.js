...
function generateCanvas (canvasEls) {
    ...
    for (var i = 0; i < digits.length; i++) {
      ...
      switch (digit) {
        case 0:
          ...
          break
        case 1:
          digitSquares = [[0, 0], [0, 4], [0, 3], [0, 2], [0, 1]]
          break
        case 2:
          digitSquares = [[0, 0], [1, 0], [2, 0], [2, 1], [2, 2], [0, 3], [2, 4], [1, 4], [0, 4], [0, 2], [1, 2]]
          break
        case 3:
          digitSquares = [[0, 0], [1, 0], [2, 0], [2, 1], [2, 2], [2, 3], [2, 4], [1, 4], [0, 4], [0, 2], [1, 2]]
          break
        case 4:
          digitSquares = [[0, 0], [1, 2], [2, 0], [2, 1], [2, 2], [2, 3], [2, 4], [0, 2], [0, 1]]
          break
        case 5:
          digitSquares = [[0, 0], [1, 0], [2, 0], [1, 2], [2, 2], [2, 3], [2, 4], [1, 4], [0, 4], [0, 2], [0, 1]]
          break
        case 6:
          digitSquares = [[0, 0], [1, 2], [2, 2], [2, 3], [2, 4], [1, 4], [0, 4], [0, 3], [0, 2], [0, 1]]
          break
        case 7:
          digitSquares = [[0, 0], [1, 0], [2, 0], [2, 1], [2, 2], [2, 3], [2, 4]]
          break
        case 8:
          digitSquares = [
            [0, 0],
  ...
  function moveApple () {
    ...
    } while (snake.filter(sq => sq[0] === apple[0] && sq[1] === apple[1]).length)
  }
